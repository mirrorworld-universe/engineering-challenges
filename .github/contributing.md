# Contributing to Mirrorworld Engineering Challenges

First and foremost, thank you! We appreciate that you want to contribute to Mirrorworld Engineering Challenges, your time is valuable, and your contributions mean a lot to us.
...
- **version**: (required) please note the version of Mirrorworld Engineering Challenges are you using
...
The original poster or the maintainers of Mirrorworld Engineering Challenges may close an issue at any time. Typically, but not exclusively, issues are closed when:
...
[so]: http://stackoverflow.com/questions/tagged/Mirrorworld Engineering Challenges
